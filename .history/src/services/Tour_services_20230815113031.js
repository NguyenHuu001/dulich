...
const DeleteItemTour = (id) => {
    return instance.delete(`/api/v1/tours/${id}`);
}
...
export { fetchTours, fetchItemTour, fetchLogin, fetchSearchTour, fetchRegister, fetchFeaturedTour, CreateItemTour,De };
