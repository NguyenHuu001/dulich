...
const CreateItemTour = (title, city, address, price, maxGroupSize, distance, desc, photo) => {
    return instance.post('api/v1/tours?page=2', title, city, address, price, maxGroupSize, distance, desc, photo);
};
