...
const CreaateItemTour = () => {
    return instance.post('api/v1/tours?page=2');
};
...
export { fetchTours, fetchItemTour, fetchLogin, fetchSearchTour, fetchRegister, fetchFeaturedTour,CreaateItemTour };
