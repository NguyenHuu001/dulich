...
const CreateItemTour = (title, city, address, distance, photo, desc, price, maxGroupSize, featured) => {
    console.log(title, city, address, distance, photo, desc, price, maxGroupSize, featured);
    return instance.post('/api/v1/tours', title, city, address, distance, photo, desc, price, maxGroupSize, featured);
};
