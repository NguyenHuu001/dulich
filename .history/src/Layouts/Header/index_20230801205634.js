            ...
            <div className="container header_in">
                <div className="wrap_header d-flex justify-content-between align-items-center">
                    <div className="col-md-5 col-sm-3">
                        <img className="logo col-md-7" src={logo} />
                    </div>
                    ...
                    <div>
                        <ul className="d-flex mb-0" style={{ listStyle: 'none' }}>
                            <a className="p-3 fs-5" href="#" style={{ textDecoration: 'none', flexGrow: 1 }}>
                                <li className="set_fw" style={{ color: 'black' }}>
                                    Login
                                </li>
                            </a>
                            <a className="fs-5 mt-2" href="#" style={{ textDecoration: 'none', flexGrow: 1 }}>
