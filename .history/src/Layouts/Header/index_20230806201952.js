                        ...
                        <ul className="d-flex justify-content-end mb-0 menu_none" style={{ listStyle: 'none' }}>
                            <a className="p-3 fs-4" href="#" style={{ textDecoration: 'none' }}>
                                <li className="set_fw" style={{ color: 'black' }}>
                                   <Link to='/home' className='link_page'> Home</Link>
                                </li>
                            </a>
                            <a className="p-3 fs-4" href="#" style={{ textDecoration: 'none' }}>
                                <li className="set_fw" style={{ color: 'black' }}>
                                    <Link to='/about' className='link_page'>About</Link>
                                </li>
                            </a>
                            <a className="p-3 fs-4" href="#" style={{ textDecoration: 'none' }}>
                                <li className="set_fw" style={{ color: 'black' }}>
                                    <Link to="/tours" className='link_page'>Tuors</Link>
                                </li>
                            </a>
                        </ul>
                    </div>
                    <div className="register_login">
                        <Link to='/login'><button className="pe-3 ps-3 fw-bolder">Login</button></Link>
                        <Link to='/register'><button className="pe-4 ps-4 btn_register">Register</button></Link>
                    </div>
