    ...
    return (
        <div className="container">
            <div className="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <Button className='header_login fs-5 p-0 ps-4 pe-4 pt-' type="link" href="#" style={{color: 'black' }}>
                        Login
                    </Button>
                    <Button className='header_register fs-5 p-0 ps-4 pe-4 pt-' type="link" href="#" style={{ color: 'black' }}>
                        Register
                    </Button>
                </div>
            </div>
