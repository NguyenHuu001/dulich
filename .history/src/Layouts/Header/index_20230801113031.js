            ...
            <div className="container pt-2 pb-2">
                <div className="d-flex justify-content-between align-items-center">
                    ...
                    <div className="d-flex">
                        <div>
                            <button className="header_login col-xs-">Login</button>
                        </div>
                        <div>
                            <button className="header_register col-xs-">Register</button>
                        </div>
                    </div>
                    <MenuOutlined className='icon_menu ps-3 col-xs-' style={{fontSize:'70px'}}/>
                </div>
            </div>
        </div>
    );
