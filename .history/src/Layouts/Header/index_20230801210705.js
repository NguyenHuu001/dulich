    ...
    return (
        <div className="container-fluid p-0 header">
            <div className="container header_in">
                <div className="wrap_header d-flex justify-content-around align-items-center">
                    <div className="col-md-5 col-sm-3 col-4">
                        <img className="logo col-md-7 col-12" src={logo} />
                    </div>
                    ...
                    <div className="p-3 col-1 ">Login</div>
                    <div className="p-3 col-1 register_li">Register</div>
