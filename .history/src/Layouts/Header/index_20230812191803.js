                        ...
                        <div className="register_login d-flex align-items-center justify-content-end flex-wrap col-md-4 col-5">
                            {role === 'admin' ? (
                                <div className="col-md-5  me-3 d-flex align-items-center" style={{ height: '30px' }}>
                                    <Link to="/adeTour" className="wrap_username">
                                        <button className=" fw-bolder username"><h6>{UserName}</h6></button>
                                    </Link>
                                </div>
                            ) : (
                                <div
                                    className="col-md-5 wrap_username me-3 d-flex align-items-center"
                                    style={{ height: '30px' }}
                                >
                                    <Link to="/home">
                                        <button className="pe-3 ps-3 fw-bolder username col-md-12">{UserName}</button>
                                    </Link>
                                </div>
                            )}
