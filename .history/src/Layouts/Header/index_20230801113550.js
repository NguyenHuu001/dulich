            ...
            <div className="container pt-2 pb-2">
                <div className="d-flex justify-content-between align-items-center">
                    ...
                    <div className="d-flex col-xs-4">
                        <div>
                            <button className="header_login col-xs-4">Login</button>
                        </div>
                        <div>
                            <button className="header_register col-xs-4">Register</button>
                        </div>
                    </div>
                    <MenuOutlined className='icon_menu ps-3 col-xs-2' style={{fontSize:'70px'}}/>
                </div>
            </div>
        </div>
    );
