...
function AccountDetails() {
    ...
    const UpdatePassWord = async () => {
        ...
        const ld = '64bfdb59c8f938647ea1e2a3'
        const accountData = {
            username: name,
            email: email,
            password: '$2a$10$UVOByQU1VRe3Lba8oplBS.W2NAZobDaz7zf0lUWeVqfpgcBwXlq9a',
        };
        try {
            const response = await UpdateAccount('64bfdb59c8f938647ea1e2a3', accountData, config);
            notification.open({
                type: 'success',
                message: 'Thành công',
            ...
            <div className="col-md-6 ">
                ...
                >
                    ...
                    <div className="d-flex justify-content-center">
                        ...
                        >
                            <Button type="primary" htmlType="submit" onClick={UpdatePassWord}>
                                Đổi mật khẩu
                            </Button>
                        </Form.Item>
                    </div>
