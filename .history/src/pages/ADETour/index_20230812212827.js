    ...
    const items = [
        {
            ...
            children: (
                <div className="container d-flex justify-content-center mt-3">
                    ...
                    >
                        <Form.Item className='col-md-3' label="Title">
                            <Input onChange={(e) => setTitle(e.target.value)} />
                        </Form.Item>
                        <Form.Item className='col-md-3' label="City">
                            <Select
                                onChange={(e) => {
                                    setCity(e);
                                }}
                        ...
                        <Form.Item className='col-md-3' label="Address">
                            <Input onChange={(e) => setAddress(e.target.value)} />
                        </Form.Item>
                        <Form.Item className='col-md-3' label="Price">
                            <InputNumber
                                onChange={(value) => {
                                    setPrice(value);
                                }}
                        ...
                        <Form.Item className='col-md-3' label="Max Group Size">
                            <InputNumber
                                onChange={(value) => {
                        ...
                        <Form.Item className='col-md-3' label="Distance">
                            <InputNumber
                                onChange={(value) => {
                                    setDistance(value);
                                }}
