...
function ADETour() {
    ...
    const [photo, setDesc] = useState('');
    useEffect(() => {
        console.log(title, city, address, price, maxGroupSize, distance, desc);
    }, [title]);
    return (
        <div className="container d-flex justify-content-center mt-5">
            ...
            >
                ...
                <div className="mt-4">
                    <Upload>
                        <Button icon={<UploadOutlined />} onChange={e => {set}}>Click to Upload Photo</Button>
                    </Upload>
                </div>
                <div className="mt-4">
                    <Form.Item>
