                ...
                <div className="mt-3 wrap_info">
                    <div className="m-4">
                        ...
                        <div className="mt-4">
                            ...
                            <span className="ms-2 ms-4">{itemTour.city}</span>
                            <FontAwesomeIcon className="icon_card" icon={faCircleDollarToSlot} />
                            <span className="ms-2 ms-4">{itemTour.price}/ per person</span>
                            <FontAwesomeIcon className="icon_card" icon={faLocationDot} size="sm" />
                            <span className="ms-2 ms-4">{itemTour.distance} k/m</span>
                            <FontAwesomeIcon className="icon_card" icon={faUserGroup} />
                            <span className="ms-2 ms-4">{itemTour.maxGroupSize} people</span>
                        </div>
