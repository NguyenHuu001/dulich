                ...
                <div className="mt-3 wrap_info">
                    <div className="m-4">
                        ...
                        <div className="mt-4">
                            ...
                            <FontAwesomeIcon className="icon_card me-5" icon={faCircleDollarToSlot} />
                            <span className="ms-2">{itemTour.price}/ per person</span>
                            <FontAwesomeIcon className="icon_card me-5" icon={faLocationDot} size="sm" />
                            <span className="ms-2">{itemTour.distance} k/m</span>
                            <FontAwesomeIcon className="icon_card me-5" icon={faUserGroup} />
