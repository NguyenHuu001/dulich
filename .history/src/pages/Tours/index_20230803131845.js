...
function Tours() {
    useEffect(() => {
        axios.get('http://localhost:4000/api/v1/tours?gidzl=jz1wEaX281AuoNawHbqX5xZ1UZfHLoL2hiDrP5W594kibtrWNLDsIwlEBMDQKdGRgy5vF3B7fMWUGa0b4m')
    }, []);
    return (
        <>
            ...
            <div className="container">
                <div class="card col-md-3">
                    ...
                    <div class="card-body">
                        ...
                        <h5>Addresssssssssssssssssssssssssssssssssssss</h5>
                        <div className="d-flex justify-content-between align-items-center">
                            <div className="mb-3 mt-4">
                                <FontAwesomeIcon className="icon_card" icon={faDollarSign} size="sm" />
                                <span className="icon_card fw-bolder">1999</span>
                                <span className="fw-bolder" style={{ color: 'gray' }}>
                                    /per person
                                </span>
                            </div>
                            <div>
                                <a href="#" class="btn btn-primary btn_book">
                                    Book Now
                                </a>
                            </div>
                        </div>
