...
import { fetchSearchTour } from '../../services/Tour_services';
import './Tours.scss';
//-------------//
...
function Tours() {
    ...
    const SearchTour = () => {
        let itemTour = fetchSearchTour();
        itemTour.then((item) => {
            setListTour(item.data);
        });
    };
                ...
                <div className="None_Item">
                            ...
                            <div className="d-flex flex-wrap">
                                <div className="col-12 col-md-3 d-flex align-items-center ms-3 mt-3 chieudai">
                                    ...
                                    <div className="ps-3 border_right">
                                        <h6>Location</h6>
                                        <input className="input_where" placeholder="Where are you going?" onChange={(e) => {
                                            setLocation(e.target.val)
                                        }}></input>
                                    </div>
                                </div>
                                <div className="col-12 col-md-3 d-flex align-items-center ms-3 mt-3 chieudai">
                    ...
                    <div className="container d-flex flex-wrap justify-content-center">
                        ...
                        <Pagination
                            className="mt-5"
                            // current={currentPage}
                            total={20} // Tổng số lượng bản ghi hoặc mục cần phân trang
