            ...
            <div className="col-md-8 wrap_chitiettour">
                ...
                <div className="mt-3 wrap_info">
                    <div className="m-4">
                        ...
                        <div className="wrap_input_review">
                            <input className="mt-3 p-3 input_review" placeholder='Chia sẻ ý kiến của bạn' type="text" style={{ width: '100%' }} />
                            <button className='btn btn_su'>Submit</button>
                        </div>
                    </div>
                </div>
            </div>
