...
import { faDollarSign, faLocationDot, faMagnifyingGlass, faPenToSquare, faStar, faUsers } from '@fortawesome/free-solid-svg-icons';
//--------------//
                                            ...
                                            <div className="card ">
                                                <div className="wrap_img">
                                                    <img
                                                        ...
                                                        style={{ width: '100%' }}
                                                    />
                                                    <FontAwesomeIcon className='Edit_tour' icon={faPenToSquare} size='2xl'/>
