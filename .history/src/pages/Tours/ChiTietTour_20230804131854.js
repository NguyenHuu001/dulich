...
function ChiTietTour() {
    return (
        <div className="container d-flex flex-wrap">
            <div className="col-md-8 col-12 wrap_chitiettour pe-2">
                <img
                    src={baner}
                    alt="anh"
                ...
                <div className="mt-3 wrap_info pe-4">
                    <div className="m-4">
                        <div>
                ...
                <div className="mt-5 wrap_info book_fixed">
                    <div className="container ps-4 pe-4">
                        ...
                        <div className='mt-5 mb-5'>
                            <button className='ntn_bookNow' style={{textAlign:'center', width:'100%'}}>Book Now</button>
                        </div>
                    </div>
                </div>
            </div>
