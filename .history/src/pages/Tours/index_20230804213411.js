...
//--------------//
import { fetchTours, fetchItemTour } from '../../services/Tour_services';
import './Tours.scss';
//-------------//
                ...
                <div className="None_Item">
                    ...
                    <div className="container Search_where">
                        <div className="col-md-12 mt-3">
                            <div className="d-flex flex-wrap">
                                <div className="col-12 col-md- d-flex align-items-center ms-3 mt-3 chieudai">
                                ...
                                <div className="col-12 col-md- d-flex align-items-center ms-3 mt-3">
                    ...
                    <div className="container d-flex flex-wrap justify-content-center">
                        ...
                        <Pagination
                            ...
                            total={16} // Tổng số lượng bản ghi hoặc mục cần phân trang
                            pageSize={8} // Số lượng mục hiển thị trên mỗi trang
