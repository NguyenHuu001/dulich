                ...
                <div className="mt-3 wrap_info">
                    <div className="m-4">
                        ...
                        <div className="mt-4">
                            ...
                            <span className="me-2">{itemTour.city}</span>
                            <FontAwesomeIcon className="icon_card ms-5" icon={faCircleDollarToSlot} />
                            <span className="me-2">{itemTour.price}/ per person</span>
                            <FontAwesomeIcon className="icon_card ms-5" icon={faLocationDot} size="sm" />
                            <span className="me-2">{itemTour.distance} k/m</span>
                            <FontAwesomeIcon className="icon_card ms-5" icon={faUserGroup} />
                            <span className="me-2">{itemTour.maxGroupSize} people</span>
                        </div>
