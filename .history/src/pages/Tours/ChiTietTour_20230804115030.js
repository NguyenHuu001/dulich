...
import { faCircleDollarToSlot, faDollarSign, faLocationDot, faMagnifyingGlass, faStar, faUsers } from '@fortawesome/free-solid-svg-icons';
            ...
            <div className="col-md-8 wrap_chitiettour">
                ...
                <div className="mt-3">
                    <div>
                        ...
                        <span className="ms-2">199/ per person
</span>
