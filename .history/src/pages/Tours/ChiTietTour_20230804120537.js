            ...
            <div className="col-md-8 wrap_chitiettour">
                ...
                <div className="mt-3 wrap_info">
                    <div className="m-4">
                        ...
                        <div>
                           <span className="icon_card icon_rating_hv"> 1 <FontAwesomeIcon  icon={faStar}/></span>
                           <span className="icon_card icon_rating_hv ms-2"> 2 <FontAwesomeIcon  icon={faStar}/></span>
                           <span className="icon_card icon_rating_hv ms-2"> 3 <FontAwesomeIcon  icon={faStar}/></span>
                           <span className="icon_card icon_rating_hv ms-2"> 4 <FontAwesomeIcon  icon={faStar}/></span>
                           <span className="icon_card icon_rating_hv ms-2"> 5 <FontAwesomeIcon  icon={faStar}/></span>
                        </div>
                        <div className='wrap_input_revoew'><input className='mt-3 p-3 input_review' type='text' style={{width:'100%'}} /></div>
                    </div>
                </div>
            </div>
