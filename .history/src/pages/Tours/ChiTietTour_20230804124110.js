                    ...
                    <div className='container'>
                        ...
                        <div>
                            ...
                            <div className='d-flex '>
                                <input className='col-md-6' type="date" style={{ border: 'none' }} />
                                <div className='col-md-12'><InputNumber className='col-md-6' style={{ width: '100%' }} min={1} max={1000} placeholder="Guest" /></div>
                            </div>
                        </div>
                    </div>
                </div>
