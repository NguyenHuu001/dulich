            ...
            <div className="col-md-8 wrap_chitiettour">
                ...
                <div className="mt-3 wrap_info">
                    <div className="m-4">
                        ...
                        <div>
                           <span className="icon_card icon_rating"> 1 <FontAwesomeIcon  icon={faStar}/></span>
                           <span className="icon_card icon_rating"> 2 <FontAwesomeIcon  icon={faStar}/></span>
                           <span className="icon_card icon_rating"> 3 <FontAwesomeIcon  icon={faStar}/></span>
                           <span className="icon_card icon_rating"> 4 <FontAwesomeIcon  icon={faStar}/></span>
                           <span className="icon_card icon_rating"> 5 <FontAwesomeIcon  icon={faStar}/></span>
                        </div>
                    </div>
                </div>
            </div>
