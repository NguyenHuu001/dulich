                ...
                <div className="mt-3 wrap_info">
                    <div className="m-4">
                        ...
                        <div>
                           ...
                           <span className="icon_card icon_rating_hv"> 2 <FontAwesomeIcon  icon={faStar}/></span>
                           <span className="icon_card icon_rating_hv"> 3 <FontAwesomeIcon  icon={faStar}/></span>
                           <span className="icon_card icon_rating_hv"> 4 <FontAwesomeIcon  icon={faStar}/></span>
                           <span className="icon_card icon_rating_hv"> 5 <FontAwesomeIcon  icon={faStar}/></span>
                        </div>
                    </div>
                </div>
            </div>
