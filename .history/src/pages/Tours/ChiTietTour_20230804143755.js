                ...
                <div className="mt-3 wrap_info">
                    <div className="m-4">
                        ...
                        <div className="mt-3">
                            ...
                            <span className="ms-2">{itemTour.title}</span>
                        </div>
                        <div className="mt-4">
                            ...
                            <span className="ms-2">{itemTour.title}/ per person</span>
                            <FontAwesomeIcon className="icon_card ms-5" icon={faLocationDot} size="sm" />
                            <span className="ms-2">{itemTour.title} k/m</span>
                            <FontAwesomeIcon className="icon_card ms-5" icon={faUserGroup} />
                            <span className="ms-2">{itemTour.title} people</span>
                        </div>
                        <h5 className="mt-5">Description</h5>
                        <span className="mt-3">{itemTour.title}</span>
                    </div>
                </div>
                <div className="mt-3 wrap_info">
                    <div className="m-4">
