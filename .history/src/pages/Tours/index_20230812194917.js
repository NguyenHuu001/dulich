        ...
        <>
            {none && (
                <div className="None_Item">
                    ...
                    <Link to="/adeTour">
                        <FontAwesomeIcon className="me-3 add_tour" icon={faSquarePlus} size="2xl" />
                    </Link>
                    <Link to="/adeTour">
                        <FontAwesomeIcon className="me-3 Edit_tour" icon={faPenToSquare} size="2xl" />
                    </Link>
                    <Link to="/adeTour">
                        <FontAwesomeIcon className=" delete_tour" icon={faTrash} size="2xl" />
                    </Link>
