            ...
            <div className="col-md-12 mt-3">
                <div className="d-flex">
                    ...
                    <div className="d-flex align-items-center ms-3">
                        ...
                        <div className="ps-3 border_right">
                            <h6>Distance</h6>
                            <InputNumber style={{width:'200px'}} min={1} max={1000} placeholder='Distance k/m'  />
                        </div>
                    </div>
                    <div className="d-flex align-items-center ms-3">
                    ...
                    <div className="d-flex align-items-center ms-3">
                    <FontAwesomeIcon style={{width:'200px'}} className="icon_search p-2" icon={faMagnifyingGlass} />
                    </div>
                </div>
            </div>
        </div>
