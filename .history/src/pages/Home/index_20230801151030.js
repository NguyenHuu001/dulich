                ...
                <div className="row d-flex">
                    ...
                    <div className="col-md-3">
                        <div className='border_items'>
                            ...
                            < className='mt-2 mb-2'>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</d>
                        </div>
                    </div>
                    <div className="col-md-3 ">
                        <div className='border_items'>
                            ...
                            <span className='mt-2 mb-2'>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</span>
                        </div>
                    </div>
                    <div className="col-md-3 ">
                       <div className='border_items'>
