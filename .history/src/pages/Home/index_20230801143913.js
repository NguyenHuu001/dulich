        ...
        <div className="container pt-5">
            ...
            <div className="col-md-12 mt-3">
                <div className="d-flex flex-wrap">
                    <div className="col-xs-12 d-flex align-items-center ms-3 chieudai">
                    ...
                    <div className="col-xs-12 d-flex align-items-center ms-3 chieudai">
                        ...
                        <div className="ps-3 pe-3 border_right">
                            <h6>Distance</h6>
                            <InputNumber style={{width:'150px'}} min={1} max={1000} placeholder='Distance k/m'  />
                        </div>
                    </div>
                    <div className="col-xs-12 d-flex align-items-center ms-3 chieudai">
                        ...
                        <div className="ps-3 pe-3 border_right">
                            <h6>Max People</h6>
                            <InputNumber style={{width:'150px'}} min={1} max={200} defaultValue={0}  />
                        </div>
                    </div>
                    <div className="col-xs-12 d-flex align-items-center ms-3">
