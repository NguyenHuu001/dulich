                    ...
                    <div className='col-md-12 col-sm-12'>
                        <div className='d-flex'>
                            <div className='col-md-3 col-xs-6 gallery_img'>
                                <img className='mb-3' style={{wi}} src={Gallery1} />
                                <img className='mb-3' style={{wi}} src={Gallery2} />
                            </div>
                            <div className='col-md-3 col-xs-6 gallery_img'>
                                <img className='mb-3' style={{wi}} src={Gallery3} />
                                <img className='mb-3' style={{wi}} src={Gallery4} />
                            </div>
                            <div className='col-md-3 col-xs-6 gallery_img'>
                                <img className='mb-3' style={{wi}} src={Gallery5} />
                                <img className='mb-3' style={{wi}} src={Gallery6} />
                            </div>
                            <div className='col-md-3 col-xs-6 gallery_img'>
                                <img className='mb-3' style={{wi}} src={Gallery7} />
                                <img className='mb-3' style={{wi}} src={Gallery8} />
                            </div>
                        </div>
                    </div>
                </div>
