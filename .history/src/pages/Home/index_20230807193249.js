                ...
                <div className="col-md-6 mt-5">
                    <div className="wrap_content">
                        <div className="top_content d-flex align-items-center">
                            ...
                            <img alt='anh' className="img_earth mt-1" src={earth} />
                        </div>
                        <h1>
                                            ...
                                            <div className="card ">
                                                ...
                                                <div className="card-body">
                                                    ...
                                                    <div className="d-flex justify-content-between align-items-center">
                                                        ...
                                                        <div>
                                                            <Link to="/tours" className="btn btn-primary btn_book">
                                                                Book Now
                                                            </Link>
                                                        </div>
                                                    </div>
                ...
                <div className="row">
                    ...
                    <div className="col-md-6">
                        <div className="d-flex justify-content-center">
                            <img alt='anh' src={banner} style={{ width: '90%' }} />
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="col-md-12 col-sm-12">
                        <div className="d-flex flex-wrap">
                            <div className="col-md-3 pb-0 gallery_img">
                                <img alt='anh' className="mb-3" src={Gallery1} />
                                <img alt='anh' className="mb-3" src={Gallery2} />
                            </div>
                            <div className="col-md-3 pb-0 col-xs-6 gallery_img">
                                <img alt='anh' className="mb-3" src={Gallery3} />
                                <img alt='anh' className="mb-3" src={Gallery4} />
                            </div>
                            <div className="col-md-3 pb-0 col-xs-6 gallery_img">
                                <img alt='anh' className="mb-3" src={Gallery5} />
                                <img alt='anh' className="mb-3" src={Gallery6} />
                            </div>
                            <div className="col-md-3 pb-0 col-xs-6 gallery_img">
                                <img alt='anh' className="mb-3" src={Gallery7} />
                                <img alt='anh' className="mb-3" src={Gallery8} />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="container mt-5 mb-5">
                <div className="row">
                    ...
                    <div className="col-md-7">
                        <img alt='anh' src={banner2} alt="banner"></img>
                    </div>
                </div>
            </div>
        </div>
