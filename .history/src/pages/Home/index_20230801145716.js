                ...
                <div className="row d-flex">
                    ...
                    <div className="col-md-3">
                        <div className="wrap_icon">
                            <FontAwesomeIcon className='icon_center' icon={faCloudSun} size="2xl" />
                        </div>
                        <h5 cl>Calculate Weather</h5>
                        <span cl>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</span>
                    </div>
